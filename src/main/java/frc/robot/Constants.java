...
public final class Constants {
  ...
  public static class TelemetryLEDConstants{
    public static final int kBlinkinPWMChannel = 1;

    //colors
    public static final double blinkinLimeOutput = 0.73;
    public static final double blinkinYellowOutput = 0.69;
    public static final double blinkinRedOutput = 0.61;
    public static final double blinkinSkyBlueOutput = 0.83;
