...
public class RobotContainer {
  ...
  private final LEDTelemetrySub ledTelemetrySub = new LEDTelemetrySub();
  ...
  public RobotContainer() {
    if(driverJoyStick.getRawButtonPressed(OIConstants.kDriverFieldOrientedButtonIdx)){
      fieldOrientToggle = !fieldOrientToggle;
    ...
    // Configure the trigger bindings
      ...
      swerveSub.setDefaultCommand(new SwerveJoystickCmd(
        ...
        fieldOrientToggle,
        () -> !driverJoyStick.getRawButton(OIConstants.kDriveLimeOrientButtonIdx),
        isAuto)); // by defualt will work on fields reference frame
  ...
  public Command getAutonomousCommand() {
    ...
    ledTelemetrySub.setDefaultCommand(new SetLEDCMD( TelemetryLEDConstants.blinkinSkyBlueOutput, ledTelemetrySub ));


    return new PathPlannerAuto("test_2024_02_30");
