...
public class SwerveJoystickCmd extends Command {
  ...
  public SwerveJoystickCmd(
          SwerveSub swerveSub, LimeLightSub limeLightSub,
          Supplier <Double> xSpdFunction, Supplier<Double> ySpdFunction, Supplier<Double> turningSpdFunction,
           Boolean fieldOrientToggle, Supplier<Boolean> limeTargetAccessed, Boolean isAuto) { // Supplier<Boolean> limeTargetAccessed//
  ...
  public void execute() {
    ...
    ChassisSpeeds chassisSpeeds;
     if(fieldOrientToggle){ // field orientations, forward is away from driver, backward is away from driver
        chassisSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(
          xspeed, yspeed, turningSpeed, swerveSub.getRotation2d());
    ...
    // if not in Auto, module states will update
    if(!isAuto)
    {
